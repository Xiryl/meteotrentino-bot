...
let GET_MeteoTrentinoRadarImage = () => new Promise((resolve, reject) => {
	let options = {
		method: 'GET',
		url: `https://content.meteotrentino.it/dati-meteo/radar/home/mosaicoG.gif`,
		headers: {
 ...
 * ============================================================================
 */
 let GET_MeteoTrentinoRadarFulminiImage = () => new Promise((resolve, reject) => {
	let options = {
		method: 'GET',
		url: `https://content.meteotrentino.it/dati-meteo/fulmini/anim_fulminiF.gif`,
		headers: {
			'Content-Type': 'image/gif'
		}
	};
 ...
 * ============================================================================
 */
let GET_BaciniSensorData = (link) => new Promise((resolve, reject) => {
	let options = {
		method: 'GET',
		url: link,
		headers: {
    ...
    p(options, (error, response) => {
		if (error) {
			...
			let tmpDate = new Date();
			let tmpTime = tmpDate.getTime();
			let tmpPath = 'octet-stream/' + tmpTime + '.csv';
			fs.writeFileSync(tmpPath, buffers);
...
module.exports = {
	...
	GET_BaciniSensorData,
	GET_MeteoTrentinoRadarFulminiImage
}
